...
class SlabDecompositionTest {
    ...
    void buildEventQueueSquare() {
        final var decomposition = new SlabDecomposition(new PVector(1, 0), square);
        decomposition.buildEventQueue(square);
    ...
    void buildEventQueueTriangle() {
        final var decomposition = new SlabDecomposition(new PVector(1, 0), triangle);
        decomposition.buildEventQueue(triangle);
        final var queue = decomposition.getQueue();
    ...
    void buildEventQueueRotatedSquare() {
        final var decomposition = new SlabDecomposition(new PVector(1, 0), rotatedSquare);
        decomposition.buildEventQueue(rotatedSquare);
        final var queue = decomposition.getQueue();
    ...
    void buildEventQueueIdents() throws IOException {
        ...
        decomposition.buildEventQueue(polygon);
        final var queue = decomposition.getQueue();
